...
async def main_async(cfg: AppConfig):
    ...
    orch.kv_store.setdefault("drive:interaction:textual_bias", 0.28)
    orch.kv_store.setdefault("drive:interaction:audio_bias", 0.10)
    orch.kv_store.setdefault("drive:interaction:motion_bias", 0.03)
    orch.kv_store.setdefault("drive:interaction:signal_threshold", 0.50)
    orch.kv_store.setdefault("drive:interaction:signal_cooldown_s", 45.0)
    orch.kv_store.setdefault("drive:interaction:quiet_after_relief_s", 12.0)
    orch.kv_store.setdefault("drive:interaction:causal_window_s", 20.0)
    orch.kv_store.setdefault("drive:interaction:persistence_window_s", 120.0)
    orch.kv_store.setdefault("drive:interaction:last_signal_ts", 0.0)
    orch.kv_store.setdefault("drive:interaction:last_relief_ts", 0.0)
    orch.kv_store.setdefault("drive:interaction:last_relief_delta", 0.0)
    orch.kv_store.setdefault("drive:interaction:last_signal_style", "")
    orch.kv_store.setdefault("drive:interaction_pending_request", {})
    orch.kv_store.setdefault("route:interaction_relief_stats", {})
